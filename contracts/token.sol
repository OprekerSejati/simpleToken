...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.1/contracts/token/ERC20/extensions/ERC20Capped.sol";

contract TokenSaya is ERC20Capped, ERC20Burnable {
    address payable public owner;
    uint256 public blockReward;

    constructor(uint256 cap, uint256 reward) ERC20("TokenSaya", "TkS") ERC20Capped(cap * (10 ** decimals())) {
